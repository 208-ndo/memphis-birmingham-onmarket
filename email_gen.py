...
- Total Agent Payout: {agent_payout_fmt} (commission + flat fee)
- Agent Commission at Full-Price Sale: {at_list_fmt}
- NOTE: Agent gets MORE from our offer than a full-price sale
...
6. Explicitly say agent will be paid {agent_payout_fmt} — more than the {at_list_fmt} at full price
7. For owner finance: seller gets NEAR FULL LIST PRICE — emphasize this
8. For cash: emphasize speed, as-is, no contingencies
...
12. Inject 1 real listing fact as a personal hook (days on market, price cut, condition words from listing)
13. Never reveal internal signals (views/day, your spread, the word "motivated")

Vary tone and structure across 4 emails:
- Email 1: Direct and confident — lead with the commission protection fact
- Email 2: Empathetic — acknowledge the frustration of a long stale listing
- Email 3: Curiosity — open with a question about the property or seller
